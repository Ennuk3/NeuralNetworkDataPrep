...
dirpath = r"\NeuralNetworkDataPrep\Example Databases\Full Charpy Curves\Full_database_MicroAlloying.csv"
...
final_database.to_csv(r"\NeuralNetworkDataPrep\Intermediate databases\UpperTJ+TranTJ_Micro.csv", index = False)
